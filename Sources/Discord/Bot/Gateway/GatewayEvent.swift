...
public enum GatewayEvent {
    ...
    case autoModerationActionExecution(GatewayEventData); #warning("Incomplete")
    case channelCreate(GatewayEventData); #warning("Incomplete")
    case channelUpdate(GatewayEventData); #warning("Incomplete")
    case channelDelete(GatewayEventData); #warning("Incomplete")
